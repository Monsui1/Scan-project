...
export default function SearchWidget() {
    ...
    //     checkMaxFullness: true,
    //     checkInBusinessNews: true,
    //     checkOnlyMainRole: true,
    //     check4State: false,
    //     check5State: false,
    //     checkExcludeAnnouncements: true,
    //     check7State: false
    //  });
    //  const handleCheckboxChange = (key) => (event) => {
    //     setCheckboxStates((prev) => ({ ...prev, [key]: event.target.checked }));
    // };
...
// Также можно вынести чекбоксы и инпуты в отедльный массивы для более удобного управления,
// const checkboxOptions = [
//     { id: "1", label: "Признак максимальной полноты", state: checkMaxFullnessState, setState: setCheckMaxFullnessState, disabled: false },
//     { id: "2", label: "Упоминания в бизнес-контексте", state: checkInBusinessNewsState, setState: setCheckInBusinessNewsState, disabled: false },
//    .....
// ];
// Рендер чекбоксов
//   {checkboxOptions.map(({ id, label, state, setState, disabled }) => (
//         <div key={id} className={styles.checkbox__wrapper}>
//             <input
//                 type="checkbox"
//                 id={id}
//                 name={id}

...
export default function ProfileWidget() {
    const isAuth = useSelector(state => state.account.isAuth); // Было бы хорошим решением использовать функции селекторы при обращении к стору и изолировать логику состояния от представления, но я пока читаю материал по нему
